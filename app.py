...
st.markdown("### Predict the Airbnb price in European cities based on your inputs.")
...
with col1:
    ...
    room_type = st.selectbox("🛏️ Room Type", list(room_type_map.keys()))
...
def make_prediction():
    ...
    pred_price = np.expm1(pred_price_log)  # Convert log price back to original scale
    return pred_price
